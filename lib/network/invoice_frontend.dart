...
class InvoicePdf {
  ...
  static Widget buildCustomerAddress() => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(customers[0]["customername"], style: TextStyle(fontWeight: FontWeight.bold)),
  ...
  static Widget buildInvoice() {
    ...
    //
    //   return [
    //     customers[0]["customercart"]["productName"],
    //     // Utils.formatDate(item.date),
    //     customers[0]["customercart"][ "productQty"],
    //     customers[0]["customercart"]["productPrize"],
    //     customers[0]["discount"],
    //     customers[0]["netPrize"]
    //   ];
    // }).toList();
